...
- Name: fr13-dashboard.spec.js >> FR-13 Dashboard (admin) — Run by: 23127325 >> TC-FR13-009 — BVA: adding a 1 VND delivered order increases the revenue by 2
- Location: scripts\fr13-dashboard.spec.js:191:5

# Error details

```
Error: revenue delta must equal 2 (= amount × 2 × N)
  ...
  - generic [ref=f1e15]:
    ...
    - generic [ref=f1e17]:
      - generic [ref=f1e18]:
        ...
        - paragraph [ref=f1e20]: 2,000,002 ₫
      - generic [ref=f1e21]:
        - heading "Tổng số đơn hàng" [level=3] [ref=f1e22]
        - paragraph [ref=f1e23]: "53"
```
